...
namespace snorri
{
    public abstract class Module : MonoBehaviour, IActor, INameable
    {
        ...
        */
        ...
        protected TriggerLocal triggerLocal;
        ...
        protected virtual void InvokeTrigger(string name, Map args) {
            triggerLocal.Trigger(name, args);
        }
